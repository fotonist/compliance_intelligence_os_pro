...
def _control_coverage_status_expr(evidence_count_col, approved_count_col):
    """
    coverage_status:
      - ACHIEVED: approved_evidence_count > 0
      - PARTIAL: evidence_count > 0
      - NOT_COVERED: else
    """
    return case(
        (approved_count_col > 0, literal("ACHIEVED")),
        (evidence_count_col > 0, literal("PARTIAL")),
...
def get_matrix(
    ...
    if standard_id is None:
        ...
        coverage_status_expr = _control_coverage_status_expr(
            evidence_count_col, approved_count_col
    ...
    coverage_status_expr_one = _control_coverage_status_expr(
        evidence_count_col_one, approved_count_col_one
    ).label("coverage_status")
